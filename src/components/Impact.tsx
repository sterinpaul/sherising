      ...
      >
        ...
        >
          {impactEvents.map((event, index) => (
            ...
            >
              <div className={`bg-[#C4A173] rounded-2xl p-6 h-48 flex flex-col justify-end shadow-lg hover:shadow-xl transition-shadow duration-300 ${
                event.isReadMore ? 'items-center justify-center' : ''
              }`}>
                {event.isReadMore ? (
